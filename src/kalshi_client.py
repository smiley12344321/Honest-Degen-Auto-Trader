...
class KalshiClient:
    ...
    def get_sports_events(self, status: str = "open") -> List[Dict[str, Any]]:
        ...
        sports_series_list = [
            # MLB, NPB & Baseball
            "KXMLBSPREAD", "KXMLBTOTAL", "KXMLBGAME", "KXMLBF5", "KXMLBF5SPREAD", "KXMLBF5TOTAL", "KXMLBTEAMTOTAL",
            "KXMLBF3", "KXMLBF7", "KXMLBRFI", "KXMLBKS", "KXMLBHIT", "KXMLBHR", "KXNPBRFI", "KXNPBTOTAL", "KXNPBGAME", "KXNPBSPREAD",
            "KXKBORFI", "KXMLB", "KXKBOGAME", "KXKBOTOTAL",
            # Basketball
            "KXWNBAGAME", "KXWNBATOTAL", "KXWNBASPREAD", "KXWNBA1HTOTAL", "KXWNBA1HSPREAD", "KXWNBAPTS",
            "KXNBAGAME", "KXNBATOTAL", "KXNBASPREAD", "KXNBAPTS",
            # Tennis
            "KXATPMATCH", "KXWTAMATCH", "KXUSOPEN", "KXUSOPENMENSINGLES", "KXUSOPENWOMENSINGLES",
            # Football
            "KXNCAAFGAME", "KXNCAAFSPREAD", "KXNCAAFTOTAL", "KXNCAAFTEAMTOTAL", "KXNCAAF1HSPREAD", "KXNCAAF1HTOTAL", "KXNCAAF1Q",
            "KXNFLGAME", "KXNFLSPREAD", "KXNFLTOTAL", "KXNFLTEAMTOTAL", "KXNFL1HSPREAD", "KXNFL1HTOTAL", "KXNFL1H",
            "KXNFLPASSYDS", "KXNFLRSHYDS", "KXNFLRECYDS", "KXNFLTD", "KXNFLPASSTDS", "KXNFLPASSCOMP", "KXNFLREC",
            # Hockey & Soccer
            "KXNHLGAME",
